                    ...
                    <div class="coming-soon-wrap">
                        <div class="coming-soon-container">
                            <div class="coming-soon-content">
                                ...
                                <h3 v-if="false">Subscribe to get notified!</h3>

                                <b-form class="text-left" v-if="false">
                                    <div class="coming-soon">
                                        <div class="">
                                ...
                                <ul class="social list-inline" v-if="false">
                ...
                <div class="coming-soon-image">
                    <div class="l-image">
                        <div class="img-content">
                            <img :src="require('../../assets/images/mindset.svg').default" alt="coming_soon" />
                        </div>
                    </div>
                </div>
            </div>
