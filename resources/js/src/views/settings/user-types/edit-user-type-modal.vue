<template>
    <div class="create-admin-modal-container">
        <b-modal
            id="edit-user-type-modal"
            modal-class="modal-notification"
            footer-class="justify-content-between"
            :title="pageTitle + ' User'" size="xl"
            >
             <b-form
                class="needs-validation"
                novalidate
                @submit.stop.prevent="submit_form"
                ...
                <b-form-row>
                    ...
                    <!-- <div class="col-md-6 mb-2">
                        ...
                        <b-form-invalid-feedback
                            :class="{
                                'd-block': isFormSubmit && !form.username,
                            }"
                            >Please fill the username</b-form-invalid-feedback
                        >
                    </div>
                    <div class="col-md-6 mb-2">
                        ...
                        <b-form-invalid-feedback
                            :class="{
                                'd-block': isFormSubmit && !form.password,
                            }"
                            >Please fill the password</b-form-invalid-feedback
                        >
                    </div> -->
                    <div class="col-md-6 mb-2">
                        ...
                        <b-form-invalid-feedback
                            :class="{
                                'd-block': isFormSubmit && !form.user_type,
                            }"
                            >Please fill the User Type</b-form-invalid-feedback>
                    </div>
                    <div class="col-md-6 mb-2">
                        <label for="userTypeCodeField" class="d-flex justify-content-between">User Type Code
                            <b-form-text id="input-live-help">*3 Characters only.</b-form-text>
                        </label>
                        <b-input
                        ...
                        <b-form-invalid-feedback
                            :class="{
                                'd-block': isFormSubmit && !form.user_role,
                            }"
                            >Please Select User Type Code</b-form-invalid-feedback
                        >
                    </div>
                    <!-- <div class="col-md-6 mb-2">
                        ...
                        ></multiselect>
                        <b-form-invalid-feedback
                            :class="{ 'd-block': isFormSubmit && !form.status }"
                            >Please Select status</b-form-invalid-feedback
                        >
                    </div> -->
                    <!----------------CHECKBOX START----------------->
                    <div class="col-md-2 mb-1 mt-2">
                            <h6 class="text-primary">User Accesses</h6>
                        </div>
                    <div class="col-md-12 mb-2 d-flex">
                        <div class="d-flex flex-column mr-3">
                            <label for="User Access">Settings</label>
                        ...
                        <div class="d-flex flex-column mr-3">
                                <label for="User Access">Verification</label>
                            <b-form-group  v-slot="{ ariaDescribedby }">
                            <b-form-checkbox-group
                                id="checkbox-group-1"
                        ...
                        <b-form-group  v-slot="{ ariaDescribedby }">
                         ...
                         <div class="d-flex flex-column mr-3">
                            <label for="User Access">Help</label>
                        <b-form-group  v-slot="{ ariaDescribedby }">
                            <b-form-checkbox-group
                                id="checkbox-group-1"
                                v-model="form.help"
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <b-form-invalid-feedback
                            :class="{
                                'd-block': isFormSubmit && !form.firstname,
                            }"
                            >Please fill the first name</b-form-invalid-feedback
                        >
                    </div>
                    <div class="col-md-4 mb-2">
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <b-form-invalid-feedback
                            :class="{
                                'd-block': isFormSubmit && !form.lastname,
                            }"
                            >Please fill the last name</b-form-invalid-feedback
                        >
                    </div>
                    <div class="col-md-6 mb-2">
                        ...
                        <b-input-group>
                            ...
                            <b-form-invalid-feedback
                                :class="{
                                    'd-block': isFormSubmit && !form.email,
                                }"
                                >Please fill the email</b-form-invalid-feedback
                            >
                        </b-input-group>
                    </div>
                    <div class="col-md-6 mb-2">
                        ...
                        <b-input-group>
                            ...
                            <b-form-invalid-feedback
                                :class="{
                                    'd-block': isFormSubmit && !form.mobile,
                                }"
                                >Please fill the mobile</b-form-invalid-feedback
                            >
                        </b-input-group>
                    </div> -->
                </b-form-row>
