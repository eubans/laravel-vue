        ...
        >
                ...
                <b-form-row>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <b-form-invalid-feedback
                            ...
                            >Please Select user type</b-form-invalid-feedback
                        >
                    </div>
                    <div class="col-md-6 mb-2">
                        ...
                        <b-form-invalid-feedback
                            ...
                            >Please Select user roles</b-form-invalid-feedback
                        >
                    </div>
                    <div class="col-md-6 mb-2">
            ...
            <template #modal-footer>
                <b-button
                    ...
                    ><i class="flaticon-cancel-12"></i> Discard</b-button
                >
    ...
    methods: {
        getUserDetails(id) {
            let loader = this.$loading.show({
                container: this.$refs.editUserModalForm,
            });
        ...
        getUserStatus() {
            let self = this;
            this.axios
                .get("/api/settings/user-active-status")
                .then(function (response) {
                    ...
                    response.data.forEach((value, index) => {
                        ...
                        options["name"] = self.$helpers.capFirstLetter(
                            value["name"]
                        );
            ...
            this.axios
                ...
                .catch(function (error) {
                    ...
                    if (error.response.data.message === undefined) {
                        toast.fire({
                            icon: "error",
                            title: "An error occured, please contact the administrator.",
                            padding: "2em",
                        });
                    } else {
                        toast.fire({
        ...
        submitCreateForm() {
            ...
            //post call
            this.axios
                .post("/api/settings/users/save", formData)
                .then(function (response) {
                    loader.hide();
